...
MageHUD uses MobHealth2/MobInfo-2 for mob health display.

Based on Tivoli's beta Nurfed HUD which used the StatRings modification by Antiarc.

Some of the features implemented in MageHUD was first implemented in other addons, credits goes out to Moog for his modification of NurfedHUD called Moog_Hud as well as to Repent for creating eCastingBar where I got the FlightMap support code from.

Once installed you can access MageHUD options by typing /MageHUD or /ah in the chat window.
...
* Party interface has been removed as it was not the intention of MageHUD to become a full unitframes-addon
